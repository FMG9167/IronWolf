...
import io.github.FMG9167.IronWolf.IronWolfEntityModel;
...
public class IronWolfClient implements ClientModInitializer {
    public static final EntityModelLayer IRON_WOLF_LAYER = new EntityModelLayer(Identifier.of(IronWolf.MOD_ID, "iron_wolf"), "main");

    @Override
    public void onInitializeClient() {
        EntityRendererRegistry.register(IronWolf.IRON_WOLF, IronWolfEntityRenderer::new);

        EntityModelLayerRegistry.registerModelLayer(IRON_WOLF_LAYER, IronWolfEntityModel::getTexturedModelData);
    }
}
